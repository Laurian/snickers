...
test_coverage: build
	...
	@DYLD_LIBRARY_PATH=$$GOPATH/src/github.com/snickers/hls/build ginkgo -r --slowSpecThreshold=20 --cover --succinct --skipPackage=db .
	@DYLD_LIBRARY_PATH=$$GOPATH/src/github.com/snickers/hls/build ginkgo -r --slowSpecThreshold=20 --cover --succinct -coverpkg=./db/mongo,./db/memory db
	@gover
